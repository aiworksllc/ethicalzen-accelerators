 ...
 * Protected by EthicalZen guardrails for customer data protection
 */
  ...
  try {
    ...
    const gatewayResponse = await axios.post(`${GATEWAY_URL}/api/proxy`, {
      messages: [
        {
          role: 'system',
          content: 'You are a helpful e-commerce customer support assistant. Help customers with product information, order status, and general inquiries. Never share payment information or process refunds directly.'
        },
        {
          role: 'user',
          content: message
